      ...
      <ScrollFadeIn>
        <div className="container mx-auto px-4">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <p className="mb-6 text-md font-sans">
              I'm <strong>Sudhanshu Jha</strong>, a final-year B.Tech student in
              <strong> Mathematics and Computing</strong> at Delhi Technological University,
            ...
            <p className="text-muted text-md font-sans">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-9 gap-6 max-w-4xl mx-auto mt-16">
            {skills.map((skill) => (
              <div
                key={skill.name}
              ...
              >
                ...
                <h4 className="text-xs mt-2 text-muted group-hover:text-primary transition-colors font-sans">{skill.name}</h4>
              </div>
            ))}
          </div>
        </div>
